...
var DispatcherTests = []DispatcherTest{
	DispatcherTest{
		...
		ExistingLinks: []ExistingLink{
			{URL: walker.URL{URL: MustParse("http://test.com/").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
		},

		ExpectedSegmentLinks: []walker.URL{
			{URL: MustParse("http://test.com/").URL,
	...
	DispatcherTest{
		...
		ExistingLinks: []ExistingLink{
			{URL: walker.URL{URL: MustParse("http://test.com/page1.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/page2.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/page404.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/page500.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},

			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled1.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled2.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled3.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled4.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled5.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			...
			{URL: walker.URL{URL: MustParse("http://test.com/getnow1.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1, GetNow: true},
			{URL: walker.URL{URL: MustParse("http://test.com/getnow2.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1, GetNow: true},
			{URL: walker.URL{URL: MustParse("http://test.com/getnow3.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1, GetNow: true},
		},

		ExpectedSegmentLinks: []walker.URL{
			// The two oldest already crawled links
			{URL: MustParse("http://test.com/page1.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -4)},
			{URL: MustParse("http://test.com/page2.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -3)},

			// 4 uncrawled links
			{URL: MustParse("http://test.com/notcrawled1.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled2.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled3.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled4.html").URL,
				LastCrawled: walker.NotYetCrawled},

			// all of the getnow links
			{URL: MustParse("http://test.com/getnow1.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/getnow2.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/getnow3.html").URL,
				LastCrawled: walker.NotYetCrawled},
		},
	},
	...
	DispatcherTest{
		...
		ExistingLinks: []ExistingLink{
			{URL: walker.URL{URL: MustParse("http://test.com/l.html").URL,
				LastCrawled: time.Now().AddDate(0, -2, -4)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/m.html").URL,
				LastCrawled: time.Now().AddDate(0, -3, -1)}, Status: http.StatusOK},

			{URL: walker.URL{URL: MustParse("http://test.com/a.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -1)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/b.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -2)}, Status: http.StatusOK},

			{URL: walker.URL{URL: MustParse("http://test.com/c.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -3)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/d.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -4)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/e.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -1)}, Status: http.StatusOK},

			{URL: walker.URL{URL: MustParse("http://test.com/f.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -2)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/g.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -3)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/h.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -4)}, Status: http.StatusOK},

			{URL: walker.URL{URL: MustParse("http://test.com/i.html").URL,
				LastCrawled: time.Now().AddDate(0, -2, -1)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/j.html").URL,
				LastCrawled: time.Now().AddDate(0, -2, -2)}, Status: http.StatusOK},
			{URL: walker.URL{URL: MustParse("http://test.com/k.html").URL,
		...
		ExpectedSegmentLinks: []walker.URL{
			// 9 Oldest links
			{URL: MustParse("http://test.com/k.html").URL,
				LastCrawled: time.Now().AddDate(0, -2, -3)},
			{URL: MustParse("http://test.com/j.html").URL,
				LastCrawled: time.Now().AddDate(0, -2, -2)},
			{URL: MustParse("http://test.com/i.html").URL,
				LastCrawled: time.Now().AddDate(0, -2, -1)},

			{URL: MustParse("http://test.com/h.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -4)},
			{URL: MustParse("http://test.com/g.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -3)},
			{URL: MustParse("http://test.com/f.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -2)},

			{URL: MustParse("http://test.com/e.html").URL,
				LastCrawled: time.Now().AddDate(0, -1, -1)},
			{URL: MustParse("http://test.com/d.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -4)},
			{URL: MustParse("http://test.com/c.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -3)},
		},
	},
	...
	DispatcherTest{
		...
		ExistingLinks: []ExistingLink{
			...
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled5.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled6.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled7.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled8.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
			{URL: walker.URL{URL: MustParse("http://test.com/notcrawled9.html").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
		...
		ExpectedSegmentLinks: []walker.URL{
			...
			{URL: MustParse("http://test.com/page2.html").URL,
				LastCrawled: time.Now().AddDate(0, 0, -3)},
			{URL: MustParse("http://test.com/page404.html").URL,
			...
			{URL: MustParse("http://test.com/notcrawled4.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled5.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled6.html").URL,
				LastCrawled: walker.NotYetCrawled},
		},
	},
	...
	DispatcherTest{
		...
		ExpectedSegmentLinks: []walker.URL{
			...
			{URL: MustParse("http://test.com/notcrawled6.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled7.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled8.html").URL,
				LastCrawled: walker.NotYetCrawled},
			{URL: MustParse("http://test.com/notcrawled9.html").URL,
				LastCrawled: walker.NotYetCrawled},
		},
	},
	...
	DispatcherTest{ // Verifies that we work with query parameters properly
		...
		ExistingLinks: []ExistingLink{
			{URL: walker.URL{URL: MustParse("http://test.com/page1.html?p=v").URL,
				LastCrawled: walker.NotYetCrawled}, Status: -1},
		},
		ExpectedSegmentLinks: []walker.URL{
			{URL: MustParse("http://test.com/page1.html?p=v").URL,
				LastCrawled: walker.NotYetCrawled},
		},
	},
	...
	var tests = []DispatcherTest{
		DispatcherTest{
			...
			ExistingLinks: []ExistingLink{
				...
				{URL: walker.URL{URL: MustParse("http://test.com/page3.html").URL,
					LastCrawled: now.AddDate(0, 0, -3)}, Status: -1},
				{URL: walker.URL{URL: MustParse("http://test.com/page4.html").URL,
					LastCrawled: now.AddDate(0, 0, -4)}, Status: -1},
			},

			ExpectedSegmentLinks: []walker.URL{
				{URL: MustParse("http://test.com/page3.html").URL,
					LastCrawled: now.AddDate(0, 0, -3)},
				{URL: MustParse("http://test.com/page4.html").URL,
...
func TestAutoUnclaim(t *testing.T) {
	...
	var tests = []DispatcherTest{
		DispatcherTest{
			...
			ExistingLinks: []ExistingLink{
				{URL: walker.URL{URL: MustParse("http://ok.com/page1.html").URL,
					LastCrawled: walker.NotYetCrawled}, Status: -1},
				{URL: walker.URL{URL: MustParse("http://ok.com/page2.html").URL,
					LastCrawled: walker.NotYetCrawled}, Status: -1},
				{URL: walker.URL{URL: MustParse("http://dead.com/page3.html").URL,
					LastCrawled: walker.NotYetCrawled}, Status: -1},
				{URL: walker.URL{URL: MustParse("http://dead.com/page4.html").URL,
					LastCrawled: walker.NotYetCrawled}, Status: -1},
			},
		},
	}
